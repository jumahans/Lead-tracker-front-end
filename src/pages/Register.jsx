            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleChange}
                  className="appearance-none block w-full px-3 py-2 pr-10 bg-white/5 border border-white/10 rounded-md placeholder-gray-500 text-white focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm"
                />
                <button
                  type="button"
